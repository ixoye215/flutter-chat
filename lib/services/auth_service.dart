...
import 'package:ixoye_chat/global/environment.dart';
import 'package:ixoye_chat/models/login_response.dart';
...
class AuthService with ChangeNotifier{
  ...
  Future<bool> login( String email, String password) async{
    ...
    //Se ponen los datos que seran enviados como un json
    final data = {
      'email': email,
      'pass': password
    };
